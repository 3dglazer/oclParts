...
int main(int argc, char** argv)
{
	...
	//path to the kernel program
    oclProgram->loadProgramSource("/myPrograms/GPUParticleSystemFinishing/particlesKernel.cl");
...
void init_gl(int argc, char** argv)
{
    ...
    nm << "Particle system running: " << NUM_PARTICLES << " particles" << std::ends;
    glutWindowHandle = glutCreateWindow(nm.str().c_str());
